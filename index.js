...
let humidityEl = document.querySelector(".humiditynum");
...
function getWeather() {
    ...
    const params = `${city}${apiKey}${units}`;
    input.value = "";
